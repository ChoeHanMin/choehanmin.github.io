...
STATS = [("7종", "게임 개발·출시"), ("30+", "경력 및 대외활동"), ("6기", "갤캠스 방장"), ("Native", "수준 영어 구사")]
...
STRENGTHS = [
    ...
    ("30건 이상의 실전 경험에서 검증된 리더십과 소통력",
     "삼성 갤럭시 대학생 서포터즈 활동에서 7인 팀의 방장이자 발표자로 우수방장으로 인정받았고, 한국외국어대학교 "
     "컴퓨팅사고 수업의 교육조교로 다양한 배경의 학생들과 소통해왔습니다. 지금까지 30건 이상의 대내외 활동에서 "
...
PAGE2_BODY = ("하나금융그룹, 삼성전자, LG CNS, 인텔 등 대기업 서포터즈부터 시대에듀·코드하나·멈블 등 스타트업, "
              "한국특수판매공제조합·한국중소벤처기업유통원·굿네이버스·LiNK와 같은 협회·공공기관, 서울시 등 광역지자체, "
              "국제 NGO까지, 업종과 규모를 가리지 않는 20건이 넘는 조직에서 함께 일해왔습니다. 금융, 교육, IT, 유통, "
              "공공, 비영리 등 서로 다른 산업의 조직들이 공통적으로 저를 찾는 이유는 어떤 환경에서도 빠르게 적응해 "
              "결과를 만들어내는 실행력 때문입니다. 다양한 조직 문화를 두루 경험한 만큼, 새로운 팀에 합류해도 빠르게 "
              "녹아들어 즉시 기여할 수 있습니다.")

ACTIVITIES = [
    ("2026.10.01 ~ 2026.10.22", "굿네이버스 SDGs PROJECT[ZERO] 지속가능개발협력 서포터즈",
     "SDGs 목표 중 6가지를 선정해 일상 속 제로웨이스트 실천 활동을 수행, 지원이 필요한 아동의 삶과 행복 증진에 기여"),
    ("2026.09.14 ~ 2026.12.13", "LilysAI 앰배서더 1기",
     "영상·PDF 등 자료를 빠르게 요약해주는 AI 서비스 LilysAI(전 세계 120만 명 이상 사용, 출시 1년 만에 손익분기점 달성)의 앰배서더로 활동, 유튜브·인스타그램·틱톡 채널을 직접 운영하며 월 10건 소개 숏폼 콘텐츠 제작 및 창업자 AI 특강 수강"),
    ("2026.09.10 ~ 2026.10.06", "스링 서포터즈 1기",
     "소모임과 카페 공간을 연결하는 스타트업 스링(Thling)의 서비스 런칭 전 SNS 콘텐츠 크리에이터로 활동, 기대감을 높이는 티저 콘텐츠와 소모임·공간 예약 타겟에 맞춘 홍보 콘텐츠 기획·제작"),
    ...
    ("2026.09 ~ 2026.11", "굿네이버스 경북사업본부 중독예방 실천활동",
     "마약 현황·피해 사례 온라인 교육 이수, SNS 캠페인 등 중독 근절 실천과제 3종 수행, 마약·중독 피해 해외 빈곤아동 지원 나눔활동 참여"),
    ("2026.09 ~ 2026.11", "제12회 세이브더칠드런 아동권리영화제 서포터즈",
     "개인 블로그에 직접 제작한 홍보 콘텐츠를 업로드해 영화제 홍보, 야외 상영 현장 스태프로 관객 관람 지원"),
    ("2026.09 ~ 2027.04", "법무법인 해율 청년봉사단 4기",
     "취약 아동·청소년, 노인, 장애 가족, 이주배경아동 등 대상별 맞춤형 체험·교육·돌봄·정서지원 활동을 수행하고, 청년 네트워크 형성과 지역사회 연계 활동에 참여"),
...
VOLUNTEER = [
    ...
    ("2026.09 ~ 2026.11", "굿네이버스 경북사업본부 중독예방 실천활동",
     "식수 위생 지원 사업에 매월 정기적으로 후원 참여"),
    ("2026.09 ~ 2026.11", "제12회 세이브더칠드런 아동권리영화제 서포터즈",
     "개인 블로그에 직접 제작한 홍보 콘텐츠를 업로드해 영화제 홍보, 야외 상영 현장 스태프로 관객 관람 지원"),
    ("2026.09 ~ 2027.04", "법무법인 해율 청년봉사단 4기",
     "취약 아동·청소년, 노인, 장애 가족, 이주배경아동 등 대상별 맞춤형 체험·교육·돌봄·정서지원 활동을 수행하고, 청년 네트워크 형성과 지역사회 연계 활동에 참여"),
    ("2026.08.31 ~ 2026.09.29", "굿네이버스 경기남부사업본부 AI 캠페인 크리에이터 2기",
     "굿네이버스 정기 후원 프로그램을 통해 매월 정기적으로 후원 참여"),
...
PROJECTS = [
    ("주요 웹사이트 제작 — choihanmin.com & soodalgames.com",
     "개인 프로젝트, 기획·디자인·개발 단독 수행",
     ["개인 브랜딩 포트폴리오 사이트(choihanmin.com)에 실시간 채팅·예약 기능, 인터랙티브 UI, 게이미피케이션 요소를 직접 구현",
      "인디 게임 스튜디오 공식 홈페이지(soodalgames.com)에 게임 7종 쇼케이스와 Google Play·Steam 연결 기능 구현",
      "UI/UX 설계와 프론트엔드 개발부터 SEO·검색엔진 등록까지 두 사이트의 전 과정을 단독 수행"]),
    ("하나 소셜벤처 유니버시티 5기",
